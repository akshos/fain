...
public class ResultSetToStringArray {
    public static String[] getStringArray1col(ResultSet rs) throws Exception{
    ...
    public static String[][] getStringArray2col( ResultSet rs ) throws Exception{
    ...
    public static String[][] getStringArray3col(ResultSet rs) throws Exception{
        Vector<String> rows = new Vector<String>();
        Vector<String> rows1 = new Vector<String>();
    ...
    public static String[] getRowAsStringArray(ResultSet rs) throws Exception{
        if(rs.next()){
