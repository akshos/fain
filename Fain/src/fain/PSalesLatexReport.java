...
import reports.SalesLatexReport;
 ...
 * @author akshos
 */
public class PSalesLatexReport extends javax.swing.JInternalFrame{
    ...
    private void generateReport(){    
        ...
        t = new Thread(new Runnable(){
            public void run(){
                ...
                boolean ret = SalesLatexReport.createReport(dbConnection, paper, orientation, dateFrom, dateTo);
                wait.closeWait();
            }
        });
        t.start();
    ...
    private void initComponents() {
        ...
        titleLabel.setText("SALES LATEX REPORT");
