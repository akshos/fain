...
import reports.BarrelDailyReport;
 ...
 * @author akshos
 */
public class PBarrelDailyReport extends javax.swing.JInternalFrame{
     ...
     */
    public PBarrelDailyReport() {
        initComponents();
    }
    
    public PBarrelDailyReport(DBConnection db, Main frame, int level){
    ...
    private void generateReport(){    
        ...
        String asOnDate=this.dateTbox.getText();
        ...
        t = new Thread(new Runnable(){
            public void run(){
                ...
                BarrelDailyReport.createReport(dbConnection, wait, paper, orientation, date);
            }
        });
        t.start();
        resetBusy();
    ...
    private void initComponents() {
        ...
        titleLabel.setText("BARREL DAILY REPORT");
