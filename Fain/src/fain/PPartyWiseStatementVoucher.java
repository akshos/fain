...
public class PPartyWiseStatementVoucher extends javax.swing.JInternalFrame{
    ...
    public PPartyWiseStatementVoucher(DBConnection db, Main frame, int level) throws Exception{
   ...
   private void loadAccountData() throws Exception{
    ...
    private void branchTboxFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_branchTboxFocusLost
        ...
        try {
            ...
            Logger.getLogger(PPartyWiseStatementVoucher.class.getName()).log(Level.SEVERE, null, ex);
        }
