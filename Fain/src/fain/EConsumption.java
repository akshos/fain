...
public class EConsumption extends javax.swing.JInternalFrame implements RefreshOption{
    ...
    private void addEntry() throws Exception{
        AConsumption item = new AConsumption(dbConnection, Codes.NEW_ENTRY, null, this.mainFrame, this.level+1, this);
        Dimension dim = Preferences.getInternalFrameDimension(item);
        if(dim != null){
            item.setSize(dim);
        }else{
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        try {
            ...
            Logger.getLogger(EConsumption.class.getName()).log(Level.SEVERE, null, ex);
        }
